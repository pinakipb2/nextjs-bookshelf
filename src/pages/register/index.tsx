      ...
      <div className="h-screen flex flex-row w-full">
        <div className="px-44 flex flex-col justify-center items-center space-y-4 w-2/3">
          ...
          <div className="items-center space-x-4">
            ...
            <Link href="/">
              <button className="bg-gray-200 hover:bg-gray-300 text-black font-thin py-2 px-5 rounded">Home</button>
            </Link>
          </div>
        </div>
          ...
          <div className="w-full px-2 rounded border border-neutral-700 bg-opacity-40">
            <div className="pt-4 pb-6">
              <div className="px-4 text-neutral-200">
                <div>
                  <p className="text-sm font-medium text-neutral-200">Register with</p>
                  <div className="mt-2 space-y-4 sm:space-y-0 sm:flex sm:space-x-2">
                    <button className="flex-1 inline-flex justify-center py-2 px-4 border rounded-md shadow-sm bg-neutral-900 border-neutral-700 text-neutral-300 hover:bg-neutral-700 text-sm font-medium">
                ...
                <div className="space-y-4 text-neutral-200">
                  ...
                  <div>
                    <button className="box-border flex justify-center w-full px-4 py-2 font-medium text-white bg-indigo-600 rounded-md text-mdhover:bg-indigo-700">Register</button>
                  </div>
                </div>
              </div>
            </div>
